  ...
  return (
    <>
      <div className="relative flex w-full flex-col items-center gap-12 overflow-clip bg-black/20 pb-6 pt-9 sm:gap-16 sm:pt-12">
        ...
        <div className="flex w-full flex-wrap items-center justify-center gap-x-5 gap-y-2 px-6 text-xs tracking-wider text-gray-300 sm:gap-x-7">
          <p className="px-2 py-1 text-center">Copyright © 2026 UNOCODE DEVELOPERS</p> 
          <svg viewBox="-2 -6 38 32" fill="currentColor" className="w-8 h-8 mx-2 text-gray-300" xmlns="http://www.w3.org/2000/svg">
