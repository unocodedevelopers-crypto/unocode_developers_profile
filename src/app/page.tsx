...
export default function Page() {
  useEffect(() => {
    const logoSvg = document.getElementById('hero-logo-svg');
    if (logoSvg) {
      const handleScroll = () => {
        ...
        logoSvg.style.transform = `scale(${scale}) rotate(${rotate}deg)`;
        
        if (progress === 1) {
            logoSvg.style.opacity = '0';
        } else {
            logoSvg.style.opacity = Math.max(0.15 - (progress * 0.15), 0.02).toString();
        }
      };
  ...
  return (
    <>
        ...
        <div className="relative flex min-h-screen w-full flex-col gap-48 overflow-clip"><a
                className="group fixed z-50 flex h-14 items-center gap-2 rounded-sm px-5 !opacity-100 lg:gap-3"
                href="/"><svg className="w-7 h-7 lg:left-11 -translate-y-[0.5px]" width="255.99998" height="255.99998"
                    viewBox="0 0 67.733328 67.733329" version="1.1" id="svg1" xmlnsXlink="http://www.w3.org/1999/xlink"
                    xmlns="http://www.w3.org/2000/svg">
                    <defs id="defs1"></defs>
                    <g id="layer1">
                        <rect style={{display:"none", fill:"#6ddfff", fillOpacity:"0.429348", strokeWidth:"0.327751"}} id="rect1"
                            width="41.862373" height="41.862373" x="26.963076" y="-20.930979" transform="rotate(45)" />
                        ...
                        <rect style={{display:"none", fill:"#ff3535", fillOpacity:"0.429348", strokeWidth:"0.163648"}} id="rect2"
                            width="20.902082" height="20.902082" x="37.443657" y="-10.451042" transform="rotate(45)" />
                        
                        <rect style={{display:"none", fill:"#ff3535", fillOpacity:"0.429348", strokeWidth:"0.163648"}} id="rect3"
                            width="20.902082" height="20.902082" x="37.443657" y="-5.2125607" transform="rotate(45)" />
                        
                        <rect style={{display:"none", fill:"#9bff35", fillOpacity:"0.429348", strokeWidth:"0.312776"}} id="rect4"
                            width="23.530884" height="23.530884" x="34.387344" y="1.0338591" transform="rotate(29.5)" />
                        ...
                        <path style={{display:"none", fill:"#4ace53", fillOpacity:"0.47482", strokeWidth:"0.264583"}}
                            ...
                            id="path8" />
                        <rect style={{display:"none", fill:"#4ace53", fillOpacity:"0.47482", strokeWidth:"0.244205"}} id="rect7"
                            width="25.254484" height="21.639776" x="32.483017" y="6.1527333"
                            transform="matrix(0.91177023,0.41070067,-0.42795537,0.90379987,0,0)" />
                    </g>
                </svg>
                <h2 className="w-fit translate-y-[1px] uppercase tracking-wider">Obermann Web Design</h2> <span
                ...
                <div className="z-50 hidden items-center gap-7 lg:flex xl:gap-10">
                    <div className="flex items-center gap-1 xl:gap-7"><a
                            className="group relative rounded-sm px-4 py-2 text-sm tracking-wide" href="/"><span
                                className="relative">Home <div
                                    className="absolute -bottom-px left-1/2 h-px -translate-x-1/2 bg-white/40 transition-all duration-300 motion-reduce:transition-none w-full">
                                </div></span> <span
                    ...
                    <div className="flex items-center xl:gap-2"><a className="group relative rounded-sm px-4 py-2"
                        ...
                        <div className="flex items-center"><button
                                className="group relative rounded-sm px-2 py-2 text-sm uppercase transition-opacity false">en
                                <span
                                    className="pointer-events-none absolute top-1/2 -translate-y-1/2 rotate-90 opacity-0 transition-all duration-200 group-hover:opacity-100 motion-reduce:transition-opacity left-1 group-hover:-left-0.5 motion-reduce:-left-0.5"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="6" height="6" viewBox="0 0 24 24"
                                        fill="#fff" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                    ...
                                    className="pointer-events-none absolute top-1/2 -translate-y-1/2 -rotate-90 opacity-0 transition-all duration-200 group-hover:opacity-100 motion-reduce:transition-opacity right-1 group-hover:-right-0.5 motion-reduce:-right-0.5"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="6" height="6" viewBox="0 0 24 24"
                                        fill="#fff" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                        strokeLinejoin="round"
                                        className="lucide-icon lucide lucide-triangle">
                                ...
                                className="group relative rounded-sm px-2 py-2 text-sm uppercase transition-opacity opacity-70 hover:opacity-100">de
                                <span
                                    className="pointer-events-none absolute top-1/2 -translate-y-1/2 rotate-90 opacity-0 transition-all duration-200 group-hover:opacity-100 motion-reduce:transition-opacity left-1 group-hover:-left-0.5 motion-reduce:-left-0.5"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="6" height="6" viewBox="0 0 24 24"
                                        fill="#fff" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
            ...
            <div className="w-full flex-1 px-5 pt-32 md:pt-36 lg:px-10 lg:pt-40 xl:pt-44">
                ...
                <div className="fixed left-0 top-0 h-lvh w-full overflow-hidden flex items-center justify-center -z-10" id="hero-scroller">
                    <svg id="hero-logo-svg" style={{width: "250px", height: "250px", opacity: 0.15, filter: "drop-shadow(0 0 40px rgba(198,20,127,0.5))", transformOrigin: "center", transition: "transform 0.05s linear"}} viewBox="0 0 67.733328 67.733329" version="1.1" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <linearGradient id="logoGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                                <stop offset="0%" style={{stopColor:"#ffffff", stopOpacity:1}} />
                                <stop offset="100%" style={{stopColor:"#c6147f", stopOpacity:1}} />
                            </linearGradient>
                        </defs>
                        <g id="layer1">
                            <path fill="url(#logoGrad)" style={{display:"inline", strokeWidth:0.264583}} d="M 31.878364,6.2538018 5.1312698,33.000896 a 1.2243857,1.2243857 90 0 0 0,1.731542 L 27.697773,57.298941 a 0.86788281,0.86788281 170.3302 0 0 1.395975,-0.237861 l 4.793567,-9.977938 A 1.194587,1.194587 69.954633 0 0 33.301161,45.476654 L 18.839909,38.962682 A 1.2027154,1.2027154 69.760409 0 1 18.24626,37.352624 L 32.66623,6.808263 A 0.48893324,0.48893324 35.13598 0 0 31.878364,6.2538018 Z" id="path3" transform="translate(-4.5683752e-4,-1.6282714e-4)" />
                        </g>
                    </svg>
                </div>
                
                <div className="absolute left-0 top-0 z-10 flex h-svh w-full flex-col items-center justify-center gap-8 text-center xl:gap-12 2xl:gap-16"
                    id="hero-wrapper">
                    <h2 className="font-inria-sans text-lg font-thin uppercase tracking-wider md:text-xl xl:text-2xl 2xl:text-3xl"
                        id="hero-supporting-title">Enough with average</h2>
                    <div
                        className="font-inria-sans text-4xl font-bold capitalize leading-[44px] tracking-[.15em] xl:text-5xl 2xl:text-6xl">
                        <h1>Your website <br className="sm:hidden" /> can do more</h1>
                    </div>
                    <p
                        className="flex flex-wrap justify-center gap-x-1 tracking-wide xs:px-16 lg:gap-x-1.5 xl:text-lg 2xl:text-xl">
                        <span>For brands that want to appear online</span><span>just as high-end as they truly
                            are.</span>
                    </p> <a id=""
                ...
                <div>
                    <div className="relative min-h-lvh">
                        <div id="social-proof-heading-wrapper"
                            className="sticky top-0 flex h-[100vh] max-h-[100vh] flex-col items-center justify-center opacity-0 motion-safe:scale-0">
                        ...
                        <div id="social-proof-scroller"
                            className="mt-[600px] flex h-[100svh] flex-col justify-end md:mt-[150px] xl:mt-[250px]"></div>
                    </div>
                    <div className="relative"><span className="absolute -top-[400px] lg:-top-[600px]" id="reviews"></span>
                        <div
                            className="relative -mt-[calc(50vh-96px)] flex w-full flex-col items-center gap-5 pb-24 lg:hidden">
                            
                        </div>
                        <div className="hidden w-full justify-center gap-4 pb-52 lg:-mt-[calc(50vh-112px)] lg:flex 2xl:-mt-[calc(50vh-128px)]"
                            id="desktop-reviews"></div>
                    </div>
                </div>
